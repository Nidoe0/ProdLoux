    ...
    <div class="row align-items-center justify-content-between gy-4">
      <div class="col-lg-6">
        <div class="p-5 rounded-4 shadow-sm" style="background:rgba(255,255,255,0.92); backdrop-filter: blur(16px);">
          ...
          <div class="mt-4">
            <a href="{{ route('login') }}" class="btn btn-primary btn-lg px-5">Se connecter</a>
          </div>
        </div>
      </div>

      <div class="col-lg-5">
        <div class="rounded-4 overflow-hidden shadow" style="min-height:420px; background-image:url('{{ asset('images/madagascar-product.svg') }}'); background-size:cover; background-position:center;">
