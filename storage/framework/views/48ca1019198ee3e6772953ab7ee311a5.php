...
<head>
    ...
    <title>Tsena Mora — <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<div class="layout-wrapper">
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            <a class="nav-link <?php echo e(request()->routeIs('vendor.dashboard') ? 'active':''); ?>"
               href="<?php echo e(route('vendor.dashboard')); ?>">
                <i class="bi bi-speedometer2"></i> Dashboard
            </a>

            <a class="nav-link <?php echo e(request()->routeIs('vendor.products.*') ? 'active':''); ?>"
               href="<?php echo e(route('vendor.products.index')); ?>">
                <i class="bi bi-box-seam"></i> Produits
            </a>

            <a class="nav-link <?php echo e(request()->routeIs('vendor.orders.*') ? 'active':''); ?>"
               href="<?php echo e(route('vendor.orders.index')); ?>">
                <i class="bi bi-receipt"></i> Commandes
            </a>

            <a class="nav-link <?php echo e(request()->routeIs('vendor.statistics') ? 'active':''); ?>"
               href="<?php echo e(route('vendor.statistics')); ?>">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown notif-badge">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow"
                        ...
                        <li>
                            <a class="dropdown-item py-2 <?php echo e(is_null($notif->read_at) ? 'fw-semibold' : ''); ?>">
                                <div style="font-size:.82rem;">
                                    <?php echo e($notif->data['message'] ?? 'Notification'); ?>
...
</html><?php /**PATH /home/kaly/Bureau/Laravele/resources/views/layouts/app.blade.php ENDPATH**/ ?>